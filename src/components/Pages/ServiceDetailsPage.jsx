...
export default function ServiceDetailsPage() {
  ...
  return (
    <>
          ...
          <div className="row align-items-center cs_gap_y_40">
            <div className="col-lg-6">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=904&h=620&q=80")',
                }}
              />
            </div>
            <div className="col-lg-6">
      ...
      <AboutStyle6
        thumbnailSrc="https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=860&h=700&q=80"
